...
import { fetchPostWithStats, toggleLike, deletePost, incrementPostViews } from '@/services/posts';
          ...
          <div className="flex gap-1">
            {post && (
              <SharePostDialog post={post}>
                <Button variant="ghost" size="icon" type="button" title="Compartilhar" aria-label="Compartilhar">
