  ...
  const handleConnect = async () => {
    ...
    try {
      if (connection) {
        ...
        setConnection(null);
        setStats(prev => ({ ...prev, connectionsCount: Math.max(0, prev.connectionsCount - 1) }));
        ...
        setStats(prev => ({
          ...prev,
          connectionsCount: conn.status === 'accepted' ? prev.connectionsCount + 1 : prev.connectionsCount,
        }));
