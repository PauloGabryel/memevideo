...
import { getConnectionStatus, sendConnectionRequest, removeConnection } from '@/services/connections';
  ...
  const handleConnect = async () => {
    ...
    try {
      if (connection) {
        ...
        setConnection(null);
        setStats(prev => ({ ...prev, connectionsCount: prev.connectionsCount - 1 }));
