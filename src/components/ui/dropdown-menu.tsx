...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[8rem] overflow-hidden rounded-md border bg-white text-slate-950 dark:bg-popover dark:text-popover-foreground p-1 shadow-lg',
      className
    )}
    {...props}
  />
